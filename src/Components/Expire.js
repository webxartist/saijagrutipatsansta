    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-50 to-red-100 px-4">
      <div className="max-w-xl w-full bg-white shadow-2xl rounded-2xl p-8 text-center">
        ...
        <p className="text-gray-600 mb-6">
          ...
          please renew your hosting as soon as possible.
        </p>
        ...
        <button className="w-full py-3 rounded-xl bg-red-600 text-white text-lg font-semibold hover:bg-red-700 transition">
          Contact Support
        </button>
